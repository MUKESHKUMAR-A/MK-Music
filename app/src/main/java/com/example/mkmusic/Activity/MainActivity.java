package com.example.mkmusic.Activity;
...
import com.example.mkmusic.Adapter.ViewPagerAdapter;
import com.example.mkmusic.DB.FavoritesOperations;
import com.example.mkmusic.Fragments.AllSongFragment;
import com.example.mkmusic.Fragments.CurrentSongFragment;
import com.example.mkmusic.Fragments.FavSongFragment;
import com.example.mkmusic.Model.SongsList;
import com.example.mkmusic.R;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        grantedPermission(mDrawerLayout);
    ...
    private void grantedPermission(View mDrawerLayout) {
